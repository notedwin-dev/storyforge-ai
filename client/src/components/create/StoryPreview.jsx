      ...
      <div className="w-full max-w-4xl mx-auto">
        <div className="card p-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Create your characters and generate a story to see it here.
          </p>
        </div>
      </div>
    );
                ...
                {story.scenes && story.scenes.length > 0 ? (
                  <div className="space-y-6">
                    <div className="mb-4">
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Detailed breakdown of each scene in the story
                      </p>
                    </div>
                ...
                {story.storyboardUrls && story.storyboardUrls.length > 0 ? (
                  <div className="space-y-6">
                    <div className="mb-4">
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Generated storyboard images with scene descriptions
                      </p>
                    </div>

                    {story.storyboardUrls.map((storyboardUrl, index) => {
                      const correspondingScene =
                        story.scenes && story.scenes[index];
                      const imageUrl = getImageURL(storyboardUrl);
                          ...
                          <div className="bg-gray-100">
                            {imageUrl ? (
                              <img
                                ...
                                onError={(e) => {
                                  console.error(
                                    `Failed to load storyboard image: ${imageUrl}`
                                  );
                                ...
                                onLoad={() => {
                                  console.log(
                                    `Successfully loaded storyboard image: ${imageUrl}`
                                  );
                                }}
                              />
                            ) : null}
                          ...
                          <div className="p-4">
                            <div className="flex items-start justify-between mb-2">
                              <h4 className="font-medium text-gray-900 dark:text-white">
                                {correspondingScene?.title ||
                                  `Storyboard ${index + 1}`}
                              </h4>
                              <div className="flex items-center space-x-2">
                                <span className="bg-primary-100 text-primary-700 px-2 py-1 rounded-full text-xs font-medium">
                                  Scene{" "}
                                  {correspondingScene?.number || index + 1}
                                </span>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <span className="ml-2 text-sm text-gray-900 dark:text-white">
                          {fullStoryText ? fullStoryText.split(" ").length : 0}{" "}
                          words
                        </span>
                      </div>
                      <div>
